...
export default function ClaimDetail() {
  ...
  return (
    <div className="flex flex-col min-h-[calc(100vh-4rem)] pb-20 animate-in fade-in duration-500 bg-surface">
      <div className="p-8 max-w-7xl mx-auto w-full space-y-8 flex-1">
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex gap-3">
            <button className="flex items-center px-4 py-2 bg-white border border-border text-dark rounded-btn shadow-sm hover:bg-gray-50 font-semibold transition-colors">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-1 border border-border rounded-card bg-white overflow-hidden shadow-card hover:shadow-lg transition-shadow">
             <FieldExtractCard fields={claimData.extractedFields} anomalies={claimData.anomalies} />
          </div>

          {/* Col 2: Gauge & Forensics */}
          <div className="lg:col-span-1 space-y-8 flex flex-col">
            <div className="bg-white rounded-card shadow-card border border-border p-6 flex flex-col items-center flex-1 transition-shadow hover:shadow-lg">
          ...
          <div className="lg:col-span-1 bg-white rounded-card shadow-card border border-border p-6 hover:shadow-lg transition-shadow">
        ...
        <div className="bg-white rounded-card shadow-card border border-border p-8 mt-8">
      ...
      <div className="fixed bottom-0 bg-white border-t border-border w-full py-4 shadow-[0_-4px_16px_rgba(0,0,0,0.05)] z-20">
