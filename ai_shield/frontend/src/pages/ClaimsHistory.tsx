          ...
          <div className="flex items-center gap-4">
            <div className="relative">
              ...
              <input
                ...
                className="pl-9 pr-4 py-2 border border-border rounded-btn text-sm w-64 bg-white focus:outline-none focus:ring-2 focus:ring-primary/50"
              />
            </div>
            <button className="flex items-center px-4 py-2 bg-white border border-border text-dark rounded-btn shadow-sm hover:bg-gray-50 font-semibold transition-colors text-sm">
              <Download className="w-4 h-4 mr-2" /> Export CSV
            </button>
          </div>
        </div>

        <div className="bg-white border text-left border-border rounded-card shadow-card overflow-hidden">
          ...
          <div className="px-6 py-4 border-t border-border flex items-center justify-between bg-surface/30">
             ...
             <div className="flex gap-2">
               <button 
                 ...
                 className="p-1 border border-border rounded-btn bg-white disabled:opacity-50 hover:bg-gray-50 flex items-center"
               >
