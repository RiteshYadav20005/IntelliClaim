...
export default function RiskBadge({ label }: RiskBadgeProps) {
  ...
  return (
    <span className="inline-flex items-center gap-1.5 rounded-badge bg-gray-100 px-2.5 py-1 text-xs font-semibold text-gray-600 ring-1 ring-inset ring-gray-600/20">
      <div className="w-3.5 h-3.5 border-2 border-gray-400 border-t-transparent rounded-full animate-spin"></div> PROCESSING
    </span>
  );
}
